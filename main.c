...
void SetColorForPixel(Image* img, int x, int y, int rgb[3]) {
...
void DrawSquare(Image* img, Square* params) {
...
int main(int argc, char** argv) {
    if (argc < 3) return 1; // need 2 args to proceed
